/* ==========================================================================
   ...
   ========================================================================== */
const PAGE_TITLES = {
  dashboard:'Dashboard', vehicles:'Vehicle Registry', drivers:'Drivers & Safety Profiles',
  trips:'Trip Dispatcher', maintenance:'Maintenance', fuel:'Fuel & Expense Management',
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  if(!canAccess(startKey, user.role)) startKey = NAV_ITEMS.find(n => n.roles.includes(user.role))?.key || 'dashboard';
  navigate(startKey);
});
